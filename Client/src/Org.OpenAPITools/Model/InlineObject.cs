...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        ...
        public InlineObject(SyncSteps syncstate = default(SyncSteps))
        {
            // to ensure "syncstate" is required (not null)
            if (syncstate == null)
            {
                throw new ArgumentNullException("syncstate is a required property for InlineObject and cannot be null");
            }
        ...
        [DataMember(Name = "syncstate", IsRequired = true, EmitDefaultValue = false)]
