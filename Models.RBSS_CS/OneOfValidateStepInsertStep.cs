...
namespace Models.RBSS_CS
{
    ...
    public abstract class OneOfValidateStepInsertStep
    {
        /// <summary>
        /// Gets or Sets IdFrom
        /// </summary>
    ...
    public class StepSpecifiedConcreteClassConverter : DefaultContractResolver
    {
        ...
        {
            if (typeof(OneOfValidateStepInsertStep).IsAssignableFrom(objectType) && !objectType.IsAbstract)
    ...
    public class StepConverter : JsonConverter
    {
        ...
        {
            return (objectType == typeof(OneOfValidateStepInsertStep));
        }
    }
}
