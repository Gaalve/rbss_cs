...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SyncBody : IEquatable<SyncBody>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SyncBody)obj);
        }

        /// <summary>
        /// Returns true if SyncBody instances are equal
        /// </summary>
        /// <param name="other">Instance of SyncBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyncBody other)
        {
        ...
        public static bool operator ==(SyncBody left, SyncBody right)
        {
