...
11: nUnion
"""
results_ex1 = read_file("testResultsTrivialex1.log")
results_ex1 = results_ex1[results_ex1[:,0].argsort()]
...
plt.show()
fig.savefig('syncTimes2_EX2.png')
